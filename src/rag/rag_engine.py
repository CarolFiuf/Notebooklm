...
class RAGEngine:
    ...
    def __init__(self):
        try:
            ...
            logger.info(f"Caches initialized: query_embedding(10k,1h), doc_metadata(5k,5m)")
    ...
    def query(
        ...
        try:
            ...
            query_embedding = self._get_cached_query_embedding(question)
    ...
    def _generate_answer(self, question: str, context: str) -> str:
        ...
        try:
            ...
            system_tokens = self.llm_service.tokenize(RAG_SYSTEM_PROMPT)
            ...
            # Build final prompt (only once!) using LangChain template
    ...
    def get_document_summary(self, document_id: int, max_chunks: int = 8) -> str:
        ...
        try:
            ...
            # Generate summary using LangChain template
